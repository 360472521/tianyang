					...
					<div class="box-footer">
						...
						<div class="box-tools pull-right">
							<ul class="pagination">
								...
								<li><a href="/user/findAll.do?page=${pageinfo.pageNum-1}&pagesize=${pageinfo.pageSize}">上一页</a>
								</li>
								...
								<c:forEach begin="1" end="${pageinfo.pages}" var="currenPage">
									<c:if test="${pageinfo.pageNum==currenPage}">
										<li ><a style="background-color: #00a7d0"
												href="/user/findAll.do?page=${currenPage}&pagesize=${pageinfo.pageSize}">${currenPage}</a>
										</li>
									</c:if>
									<c:if test="${pageinfo.pageNum!=currenPage}">
										<li>
											<a href="/user/findAll.do?page=${currenPage}&pagesize=${pageinfo.pageSize}">${currenPage}</a>
										</li>
									</c:if>
								</c:forEach>

								<li><a href="/user/findAll.do?page=${pageinfo.pageNum+1}&pagesize=${pageinfo.pageSize}">下一页</a>
								</li>
								<li>
									<a href="/user/findAll.do?page=${pageinfo.pages}&pagesize=${pageinfo.pageSize}"
